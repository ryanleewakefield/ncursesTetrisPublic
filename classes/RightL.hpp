#ifndef __RIGHTL_HPP__
#define __RIGHTL_HPP__
...
class RightL : public Tetrimino{
public:
    RightL(Environment* env, int color, std::vector<unsigned int>& Xs, std::vector<unsigned int>& Ys)
...
bool RightL::rotateLeftOrientationZero(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateLeftOrientationOne(){
int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateLeftOrientationTwo(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateLeftOrientationThree(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
void RightL::doRotateLeft(int incX, int incY, unsigned int newOrientation){
    /*
        Zero       One         Two         Three
...
bool RightL::rotateRightOrientationZero(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateRightOrientationOne(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateRightOrientationTwo(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
bool RightL::rotateRightOrientationThree(){
    int cX = cells[2].getx();
    int cY = cells[2].gety();
...
void RightL::doRotateRight(int incX, int incY, unsigned int newOrientation){
    /*
        Zero       One         Two         Three
